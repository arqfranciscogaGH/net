...
{
    public partial class AdministracionArea : System.Web.UI.Page
    {
        ...
        private static Area _entidad;
        private static List<Area> _lista;
        ...
        private void DefinirCaptura()
        {
            ...
            captura.IdPlaneacionCaptura = 1015;
        ...
        {
            administradorNegocio = new AdministradorArea();
        ...
        protected void Accion_Click(object sender, EventArgs e)
        {
            ...
            UcWebMensaje1.MostrarMensaje("Área, Acción:" + accion, "Se realizó la  operación completa", UcWebMensaje.TipoImagen.Informativo, UcWebMensaje.BotonesMensaje.Aceptar, this, ObtenerRespuesta);
        }
