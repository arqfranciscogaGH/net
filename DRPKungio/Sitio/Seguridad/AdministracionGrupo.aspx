<%@ Page Language="C#"   AutoEventWireup="true" EnableEventValidation = "false"  CodeBehind="AdministracionGrupo.aspx.cs" Inherits="Sitio.Seguridad.AdministracionGrupo" %>
...
<head runat="server">
    ...
    <title> Admistración de Grupo </title>
