<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdministrarRespuestas.aspx.cs" Inherits="Sitio.AdministracionControles.AdministrarRespuestas" %>
...
<body>
    <form id="FrmAdministracionRespuestas" runat="server">
      <div class="Pagina_Seccion">    
           ...
           <section class="Banner_Seccion">
            ...
            <section class="Captura_Seccion AltoGde" runat="server">
