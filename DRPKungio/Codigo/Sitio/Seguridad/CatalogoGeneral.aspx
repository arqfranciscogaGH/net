<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation = "false"  CodeBehind="CatalogoGeneral.aspx.cs" Inherits="Sitio.Seguridad.CatalogoGeneral" %>
...
<body>
    <form id="frmAdministracionCatalogos" runat="server">
           ...
           <section class="Banner_Seccion">
            ...
            <section class="Captura_Seccion" runat="server">
                  <div ID="SelccionOpciones" class= "Marco"  runat="server"> 
                        <asp:Label  ID="lblAplicacion" runat="server"> Aplicación</asp:Label>
