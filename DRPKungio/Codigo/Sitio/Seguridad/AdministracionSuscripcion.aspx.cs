...
{
    public partial class AdministracionSuscripcion : System.Web.UI.Page
    {

        #region  paso  2  declaracion variables

        private string ClaveAplicacion = "AdministracionSuscripcion";
        ...
        private static Suscripcion _entidad;
        private static List<Suscripcion> _lista;
        ...
        private void DefinirCaptura()
        {
            ...
            captura.IdPlaneacionCaptura = 1019;
        ...
        private void ConfigurarAlCargarPaginaSoloInicialmente()
        {
            ...
            _entidad = administradorNegocio.Instanciar<Suscripcion>();
        ...
        private void Configurar()
        {
            ...
            ucWebConsultorDinamico1.DefinirColumnasConsulta(_tipoEntidad, "IdSuscriptor,NombreCorto,Activo", "");
        }
        ...
        {
            _entidad = administradorNegocio.Obtener<Suscripcion>(s => s.IdSuscriptor == IdElemento);
            return _entidad;
        }
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                if (IdElemento != null && IdElemento != 0)
                {
                    ...
                    if (_entidad != null)
                    {
                        administradorNegocio.Eliminar((Suscripcion)_entidad);
                        administradorNegocio.GuardarCambios();
