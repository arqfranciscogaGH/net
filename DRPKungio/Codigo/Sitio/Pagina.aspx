<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pagina.aspx.cs" Inherits="Sitio.Pagina" %>
...
<%--                    <uc2:UcWebMenuFuncionalidad ID="UcWebMenuFuncionalidad2" runat="server" Idmenu="1" />--%>
           ...
           <section class="Banner_Seccion">
            ...
            <section class="Contenido_Seccion">
                ...
                <article>
                    <p>
                        Esto  es una  prueba de articulo, Esto  es una  prueba de articulo, Esto  es una  prueba de articulo,Esto  es una  prueba de articulo
                    </p>
                </article>
