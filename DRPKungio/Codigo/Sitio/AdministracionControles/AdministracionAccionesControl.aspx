<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdministracionAccionesControl.aspx.cs" Inherits="Sitio.AdministracionControles.AdministracionAccionesControl" %>
...
<head runat="server">
    ...
    <title>Acciones de preguntas</title>
...
<body>
    <form id="frmAAccionesPreguntas" runat="server">
...
<%--                  <div ID="SelccionOpciones" class= "Marco"  runat="server"> 
                          <asp:Label ID="Label1" runat="server" CssClass="Etiqueta ColorTema  ColTit2" Text="Cuestionario Origen"></asp:Label>
                          <asp:DropDownList ID="DropDownListaCuestionarioOrigen" CssClass="ListaDespegable BordeIzq ColorTema Col2"  runat="server"></asp:DropDownList>
                          <asp:Label ID="Label2" runat="server" CssClass="Etiqueta ColorTema  ColTit2" Text="Cuestionario Afectado"></asp:Label>
                          <asp:DropDownList ID="DropDownListaCuestionarioAfectado" CssClass="ListaDespegable BordeIzq ColorTema Col2" runat="server"></asp:DropDownList>
                 </div> --%>
