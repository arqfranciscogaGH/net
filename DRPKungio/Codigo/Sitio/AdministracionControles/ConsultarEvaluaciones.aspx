<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarEvaluaciones.aspx.cs" Inherits="Sitio.AdministracionControles.ConsultarEvaluaciones" %>
...
<head runat="server">
    ...
    <title>Planeación de evaluaciones</title>
...
<body>
    <form id="frmConsultarEvaluaciones" runat="server">
...
<%--            <section class="Captura_Seccion AnchoTotal AltoCh" runat="server">
                <div ID="BloqueCaptura"  runat="server"> 
                </div> 
            </section>--%>
            <section class="Consultor_Seccion  AnchoAuto AltoTotal " runat="server">
                  <uc4:ucwebconsultordinamico ID="ucWebConsultorDinamico1"  runat="server"  max-height="600px"   max-Width="800px"   Wrap="True"  ActivarFiltro="true" ActivarSeleccion="true" ActivarResumir="true" GridLines="Both" CellSpacing="1" ActivarOrden="true"   TituloSeleccion=""  TituloVentana="Planeación de Evaluaciones"  />    
            </section>
