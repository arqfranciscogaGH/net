<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acceso.aspx.cs" Inherits="Sitio.Acceso" %>
...
<body>
    <form id="frmAcceso" runat="server">
       <div id="textoAyuda"></div> 
        ...
        <section class="contenidoAcceso">
             <div class="bloqueEncanezadoSesion">
             </div>
            <div  id="BloqueCaptura" class="bloqueSesion"   runat="server">
