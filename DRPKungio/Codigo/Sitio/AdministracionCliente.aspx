<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation = "false"  CodeBehind="AdministracionCliente.aspx.cs" Inherits="Sitio.AdministracionCliente" %>
...
<head runat="server">
    ...
    <title> Admistración de Cliente </title>
    ...
    <div class="Pagina_Seccion">    
           ...
           <section class="Banner_Seccion">
            ...
            <section class="Consultor_Seccion AltoTotal" runat="server">
                  <uc4:ucwebconsultordinamico ID="ucWebConsultorDinamico1"  runat="server"  max-Width="200px"  TituloVentana="Prospectos"  Wrap="True"  ActivarFiltro="true" ActivarSeleccion="true" ActivarResumir="false"  ActivarOrden="true"  GridLines="Both" CellSpacing="1"  TituloSeleccion=""   />    
