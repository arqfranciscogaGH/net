<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarArchivoCarrusel.aspx.cs" Inherits="Sitio.AgregarArchivoCarrusel" %>
...
<body class="cuerpo">
    <form id="form1" runat="server">
       <section id="AdministracionDocumentos">
             <h3> Administración de anucios de carrusel </h3>
             <br />
             <br />
             <asp:Label id="lblDocumento" Runat="server" Text =""  CssClass="Etiqueta ColorTema" ></asp:Label>
             <br />
             <br />
             <h3> Información de anucio </h3>
             <br />
             <br />
             <asp:Panel id="Panel2" Visible="true" Runat="server">
                 <asp:TextBox ID="txtTitulo" placeholder="Titulo:" text="" rows="5" TextMode="multiline" CssClass="textarea ColorTema BordeIzq" runat="server" ></asp:TextBox>
                 <asp:TextBox ID="txtMensaje" placeholder="Mensaje:" text="" rows="5" TextMode="multiline" CssClass="textarea ColorTema BordeIzq" runat="server" ></asp:TextBox>
                 <p></p>
                 <br />
