...
{
    public partial class ConsultaComisionesRed : System.Web.UI.Page
    {

        #region  paso  2  declaracion variables

        private string ClaveAplicacion = "ConsultaComisionesRed";
        ...
        private void ConfigurarAlCargarPaginaSoloInicialmente()
        {
            ...
            ObjectResult<ConsultarComisionesPorSocio_Result> resultado = modelo.ConsultarComisionesPorSocio(idUsuario, "Red");
