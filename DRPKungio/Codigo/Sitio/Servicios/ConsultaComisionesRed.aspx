<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaComisionesRed.aspx.cs" Inherits="Sitio.Servicios.ConsultaComisionesRed" %>
...
<head runat="server">
     <title> Consulta Comisiones de Red  </title>
    <meta charset="utf-8"/>
...
<body>
    <form id="frmConsultaComisionesRed" runat="server">
    <div class="Pagina_Seccion">    
           ...
           <section class="Banner_Seccion">
            ...
            <section class="Consultor_Seccion AltoTotal" runat="server">
                  <uc4:ucwebconsultordinamico ID="ucWebConsultorDinamico1"  runat="server"  max-Width="200px"   Wrap="True"  ActivarFiltro="true" ActivarSeleccion="true" ActivarResumir="false"  ActivarOrden="true"  GridLines="Both" CellSpacing="1"  TituloSeleccion=""  TituloVentana="Comisiones de mi Red"  />    
