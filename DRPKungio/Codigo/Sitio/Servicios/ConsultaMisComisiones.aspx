<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaMisComisiones.aspx.cs" Inherits="Sitio.Servicios.ConsultaMisComisiones" %>
...
<head runat="server">
     <title> Consulta de  mis comisiones  </title>
    <meta charset="utf-8"/>
...
<body>
    <form id="frmConsultaMisComisiones" runat="server">
    <div class="Pagina_Seccion">    
           ...
           <section class="Banner_Seccion">
            ...
            <section class="Consultor_Seccion AltoTotal" runat="server">
                  <uc4:ucwebconsultordinamico ID="ucWebConsultorDinamico1"  runat="server"  max-Width="400px"   Wrap="True"  ActivarFiltro="true" ActivarSeleccion="true" ActivarResumir="false"  ActivarOrden="true"  GridLines="Both" CellSpacing="1"  TituloSeleccion=""  TituloVentana="Mis Comisiones"  />    
